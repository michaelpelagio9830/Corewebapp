<%-- 
    Document   : index-user
    Created on : Oct 26, 2019, 9:33:39 PM
    Author     : Kel
--%>
        ...
        <div class="container" >
            <div class="row">
                <div class="col-lg-9 col-md-9 col-sm-9">
                   ...
                   <h3>All Notifications Sent By Admin  <span class="label label-danger">New: 5</span></h3>
                                ...
                                <table class="table table-striped table-bordered table-hover">
                                    ...
                                    <tbody>
                                        <tr>
                                            ...
                                            <td>Admin Notification Subject Text</td>
                                            <td>2nd July 2014</td>
                                            <td><a href="notification-single.jsp" class="label label-success">Details <i class="fa fa-forward"></i></a></td>
                                        </tr>
                                       <tr>
                                            <td>#110</td>
                                            <td><span class="label label-danger">UnRead</span></td>
