<%-- 
    Document   : index-user
    Created on : Oct 26, 2019, 9:50:49 PM
    Author     : Kel
--%>
        ...
        <div class="container" >
            <div class="row">
                <div class="col-lg-9 col-md-9 col-sm-9">
                      ...
                      <h3>All Tickets <span class="label label-warning">Total: 2065</span></h3>
                                ...
                                <table class="table table-striped table-bordered table-hover">
                                    ...
                                    <tbody>
                                        <tr>
                                            ...
                                            <td><span class="label label-info">Template Support</span></td>
                                            <td>2nd July 2014</td>
                                            <td><span class="label label-default">Medium </span></td>
                                            <td><a href="single-ticket.html" class="label label-success">Details <i class="fa fa-forward"></i></a></td>
                                        </tr>
                                       <tr>
                                            <td>#110</td>
